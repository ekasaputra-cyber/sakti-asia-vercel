          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4 text-slate-400 leading-relaxed">
                ...
                <p>
                  Berawal dari komunitas belajar kecil di pojok kantin, kini
                  SAKTI telah bertransformasi menjadi organisasi mahasiswa
                  terbesar di Fakultas Ilmu Komputer dengan lebih dari 500
                  alumni yang tersebar di berbagai perusahaan teknologi top
                  tier.
                </p>
              </div>
        ...
        <div className="container px-4 md:px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-400 mt-2">
              Para pemimpin terdahulu yang telah meletakkan fondasi.
            </p>
          </div>
